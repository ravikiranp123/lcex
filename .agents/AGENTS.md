...
*   **No Auto-Progression:** Under no circumstances is the agent allowed to proceed to the next task or phase of implementation without explicit permission and approval from the user.
